...
import M4_img1 from '../../image/M4_img1.jpg'
import M4_img2 from '../../image/M4_img2.png'
import M4_img3 from '../../image/M4_img3.png'
function Main4() {
    return (
        <div className='w-full h-[600px] bg-white'>
            <div className="w-[85%] h-[90%] grid grid-cols-3 m-auto mt-[20px]">
                <div className="w-[95%] flex flex-col">
                    <img src={M4_img1} alt="" className='w-[100%] h-[50%]' />
                ...
                <div className="w-[95%] flex flex-col">
                    <img src={M4_img2} alt="" className='w-[100%] h-[50%]' />
                ...
                <div className="w-[95%] flex flex-col">
                    <img src={M4_img3} alt="" className='w-[100%] h-[50%]' />
